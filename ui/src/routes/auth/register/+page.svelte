...
<svelte:head>
	<title>Create Account — PokeHub</title>
</svelte:head>
...
>
	<div class="mb-7">
		<h1 class="font-syne font-bold text-xl text-ph-text leading-tight">Create account</h1>
		<p class="text-ph-muted text-sm mt-1 font-dm">Start building your collection</p>
	</div>
	...
	>
		<div class="space-y-5">
			<!-- Display Name -->
			<div>
				<label for="displayName" class="auth-label">Trainer name <span class="normal-case opacity-60">(optional)</span></label>
				<input
					id="displayName"
					name="displayName"
					type="text"
			...
			<div>
				...
				<p class="text-ph-muted text-xs mt-1.5 font-dm">Minimum 8 characters</p>
			</div>
		</div>
