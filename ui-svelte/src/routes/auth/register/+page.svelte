...
>
	<div class="mb-7">
		<h1 class="font-geist font-bold text-xl text-ph-text leading-tight">Create account</h1>
		<p class="text-ph-muted text-sm mt-1">Start building your collection</p>
	</div>
	...
	>
		<div class="space-y-5">
			...
			<div>
				...
				<p class="text-ph-muted text-xs mt-1.5">Minimum 8 characters</p>
			</div>
		</div>
